...
" ====== Base config for Kali Linux terminal ======

" Подгрузим базовый пример настроек
...
" Буфер обмена (используем системный)
...
" Быстрая вставка фигурных скобок
inoremap { {}<Left>
